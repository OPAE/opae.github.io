...
only runs on the Intel Xeon with Arria 10 FPGA. You cannot run it on Intel FPGA PACs. 
...
## Revision History ##
 ...
 | ---------------- |----------|
 | 2019.05.13 | No change from the previous release. |
 | 2018.05.21 | Corrected typos.  | 
